 <?php
  ...
  include __DIR__ . '/model/model_teams.php';///FIX ME
  include __DIR__ . '/include/functions.php';//FIX ME TOO!!!!!!!!!!!
  if (isPostRequest()) {
...
<div class="col-sm-offset-2 col-sm-10"><h3><a href="./view.php">View Teams</a></h3></div>
  ...
  <form class="form-horizontal" action="addTeam.php" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="team name">Patient ID: </label>
      <div class="col-sm-10">
