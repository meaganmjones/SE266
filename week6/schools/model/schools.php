<?php
//this file is for the Schools class and contains the following functions:
    //insertSchoolsFromFile - load schools into db using csv file, returns true if successful
    //deleteAllSchools - deletes junk from db before inserting
    //getSchoolCount - counts # of schools in db
    //getSelectedSchools - used to search for schools
    //############################################################################################################

class Schools
{

    private $schoolData;  //represents the database

    const MAX_INSERT_ROWS = 1000;   // Maximum number of records to insert into database for testing
